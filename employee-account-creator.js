(function(root) {
  ...
  function buildStatusSummaryStripHtml() {
    return '<div id="lmb_status_strip" class="lmb-status-strip" aria-label="Tổng quan DMS Assistant">' +
      '<div class="lmb-status-card"><span>Phiên bản</span><b>v' + escapeHtml(EXTENSION_VERSION) + '</b></div>' +
      '<div class="lmb-status-card"><span>Worker</span><b id="lmb_worker_status_summary">Sẵn sàng</b></div>' +
      '<div class="lmb-status-card"><span>File kết quả</span><b id="lmb_result_status_summary">Chưa có file</b></div>' +
      '</div>';
  }
  ...
  function ensureUiStyles() {
    ...
    style.textContent = [
      ...
      ".lmb-footer{font-size:11px;color:#64748b;display:flex;align-items:center;gap:6px}.lmb-footer b{color:#0f766e;font-weight:900}.lmb-card .lmb-footer{color:#64748b}.lmb-card .lmb-footer b{color:#0f766e}",
      ...
      "#lmb_control_center{position:fixed;right:18px;bottom:20px;z-index:2147483647;width:min(420px,calc(100vw - 36px));background:var(--lmb-bg);color:var(--lmb-ink);border:1px solid #dbe4ef;border-radius:8px;box-shadow:0 22px 56px rgba(15,23,42,.18);overflow:hidden}.lmb-control-center{display:grid}.lmb-control-head{padding:14px;background:#fff;color:#0f172a;display:flex;align-items:flex-start;justify-content:space-between;gap:12px;border-bottom:1px solid #dbe4ef}.lmb-control-brand{display:flex;align-items:center;gap:10px;min-width:0}.lmb-control-avatar{width:38px;height:38px;border-radius:8px;background:var(--lmb-blue-soft);display:flex;align-items:center;justify-content:center;border:1px solid #bfdbfe;flex:0 0 auto}.lmb-control-avatar span{width:27px;height:22px;border-radius:7px;background:var(--lmb-blue);color:#fff;display:flex;align-items:center;justify-content:center;font:900 11px var(--lmb-font)}.lmb-ai-kicker{color:#0b66d8;font-size:10px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.lmb-control-title{font-weight:950;font-size:14px;line-height:1.25;color:#0f172a}.lmb-control-subtitle{margin-top:3px;color:#64748b;font-size:12px;line-height:1.35}.lmb-control-body{padding:11px 12px 12px;display:grid;gap:10px;max-height:min(540px,calc(100vh - 190px));overflow:auto;background:var(--lmb-bg)}.lmb-status-strip{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.lmb-status-card{border:1px solid #dbe4ef;background:#fff;border-radius:8px;padding:8px;min-width:0}.lmb-status-card span{display:block;color:#64748b;font-size:10px;font-weight:900}.lmb-status-card b{display:block;margin-top:2px;color:#0f172a;font-size:11px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.lmb-create-checklist{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.lmb-create-checklist span{display:flex;align-items:center;gap:6px;min-width:0;border:1px solid #dbe7f5;background:#f8fbff;border-radius:8px;padding:8px;color:#334155;font:850 11px/1.25 var(--lmb-font)}.lmb-create-checklist b{width:18px;height:18px;border-radius:999px;background:var(--lmb-blue);color:#fff;display:inline-flex;align-items:center;justify-content:center;font-size:10px;flex:0 0 auto}.lmb-control-actions{display:grid;grid-template-columns:1fr;gap:8px}.lmb-control-primary{width:100%;border:1px solid var(--lmb-blue);border-radius:8px;background:linear-gradient(135deg,#1e88ff,#0ea5e9);color:#fff;padding:12px;font:950 13px/1.2 var(--lmb-font);cursor:pointer;text-align:left;box-shadow:0 10px 22px rgba(30,136,255,.22)}.lmb-control-primary small{display:block;font-size:11px;font-weight:800;color:#eaf6ff;opacity:.95;margin-top:3px}.lmb-control-primary:hover{filter:brightness(1.04)}.lmb-control-primary:disabled{opacity:.65;cursor:not-allowed}.lmb-control-meta{display:flex;justify-content:space-between;align-items:center;gap:8px;padding-top:2px}.lmb-review-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,280px);gap:12px;align-items:start}.lmb-review-summary{display:grid;gap:8px}.lmb-review-next{font-weight:800;color:#0f172a;font-size:12px}",
      "#lmb_admin_panel{position:fixed;left:18px;right:auto;bottom:20px;z-index:2147483647;width:min(560px,calc(100vw - 36px));border-radius:8px;box-shadow:0 22px 58px rgba(15,23,42,.2);background:#fff;color:#0f172a;border:1px solid #dbe4ef;overflow:hidden;font:13px/1.45 var(--lmb-font)}.lmb-admin-body{position:relative;padding:14px 42px 14px 14px;display:grid;gap:11px;background:#f8fbff}.lmb-admin-top{display:flex;justify-content:space-between;align-items:flex-start;gap:10px}.lmb-admin-title{font-weight:950;color:#0f172a}.lmb-admin-message{color:#334155;line-height:1.5}.lmb-admin-hint{font-size:12px;color:#475569;border-left:3px solid var(--lmb-blue);padding-left:8px}.lmb-admin-progress{display:grid;gap:6px}.lmb-admin-progress-head{display:flex;justify-content:space-between;color:#475569;font-size:12px;font-weight:800}.lmb-admin-progress-track{height:8px;border-radius:999px;background:#dbe7f5;overflow:hidden}.lmb-admin-progress-bar{height:100%;border-radius:999px;background:linear-gradient(90deg,#1e88ff,#0ea5e9);transition:width .18s ease}.lmb-admin-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.lmb-admin-stat{border:1px solid #dbe4ef;border-radius:8px;padding:8px;background:#fff}.lmb-admin-stat span{display:block;color:#64748b;font-size:11px;font-weight:800}.lmb-admin-stat b{display:block;margin-top:2px;color:#0f172a;font-size:18px;line-height:1}.lmb-admin-current,.lmb-admin-error{border:1px solid #dbe4ef;border-left:3px solid var(--lmb-blue);border-radius:8px;padding:9px;background:#fff;display:grid;gap:3px}.lmb-admin-error{border-left-color:var(--lmb-danger);background:#fff5f5}.lmb-admin-card-label{color:#64748b;font-size:11px;font-weight:900}.lmb-admin-card-title{color:#0f172a;font-weight:950}.lmb-admin-card-meta{color:#475569;font-size:12px}.lmb-run-controls{display:flex;gap:8px;flex-wrap:wrap}@media(max-width:720px){#lmb_control_center{left:18px;right:18px;width:auto}.lmb-status-strip,.lmb-create-checklist{grid-template-columns:1fr}.lmb-employee-card{left:12px;right:12px;bottom:12px;width:auto;max-height:calc(100vh - 24px)}#lmb_admin_panel{left:18px;right:18px;bottom:236px;width:auto}.lmb-review-grid{grid-template-columns:1fr}.lmb-toast{left:18px;right:18px;bottom:410px;max-width:none}body.lmb-review-open .lmb-toast{top:12px;bottom:auto}}"
    ].join("\n");
  ...
  function refreshLatestResultAttachmentUi() {
    ...
    var resultSummary = typeof document !== "undefined" ? document.getElementById("lmb_result_status_summary") : null;
    if (checkbox) {
    ...
    if (resultSummary) resultSummary.textContent = latestResultAttachment ? latestResultAttachment.filename : "Chưa có file";
  }
  ...
  function installEmployeeImportButton() {
    ...
    panel.innerHTML =
      ...
      '<div class="lmb-create-checklist" aria-label="Checklist tạo nhân viên">' +
      '<span><b>1</b>Chọn ngành</span>' +
      '<span><b>2</b>Nhập Excel/CSV</span>' +
      '<span><b>3</b>Theo dõi dashboard</span>' +
      '</div>' +
