(function(root) {
  ...
  function getExtensionAssetUrl(path) {
    ...
    try {
      if (chromeApi && chromeApi.runtime && chromeApi.runtime.getURL) {
        return chromeApi.runtime.getURL(cleanPath);
      }
    } catch (e) {}
    return cleanPath;
  }
  ...
  function buildRobotIconHtml() {
    return '<span class="lmb-robot-icon" aria-hidden="true"><img class="lmb-robot-img" alt="" src="' +
      escapeHtml(getExtensionAssetUrl("icons/kido-helper-128.png")) +
      '"></span>';
  }
